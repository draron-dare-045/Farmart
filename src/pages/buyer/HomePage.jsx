...
const BuyerHomePage = ({ onNavigate }) => {
  ...
  return (
    <section className="min-h-screen bg-gray-200 py-12 px-4 sm:px-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative w-full max-w-xs">
            <input
              ...
              className="w-full px-4 py-2 bg-white text-gray-800 placeholder-gray-500 rounded-full border border-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200"
            />
            <svg
