      ...
      <div className="max-w-6xl w-full space-y-16">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            {creators.map((creator) => (
              <div
                key={creator.github}
                className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 hover:scale-[1.02] transition"
              >
                <img
                  src={creator.image}
                  alt={creator.name}
                ...
                <a
                  ...
                  aria-label={`${creator.name} GitHub profile`}
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 text-sm max-w-3xl mx-auto leading-relaxed">
            ...
            and real-time trading opportunities.
          </p>
